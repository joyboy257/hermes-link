...
### Step 1: Install hermes-link skill

```bash
mkdir -p ~/.hermes/skills/productivity/hermes-link
cd ~/.hermes/skills/productivity/hermes-link

# Download SKILL.md
curl -sL "https://raw.githubusercontent.com/joyboy257/hermes-link/main/registry/skills/hermes-link/SKILL.md" -o SKILL.md
```
